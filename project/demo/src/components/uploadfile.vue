<template>
  <div style="height:550px;">
    ...
    <el-button id="upload" @click="upload()" style="height:50px;width:100px;margin-top:50px" size="small">
      上传表单
    </el-button>
    <br><br>
    <p style="color:red">注：可以将表单中的内容上传到node_test文件夹下的data文件中</p>
    <!-- 表单对话框 -->
    <el-dialog
        title="导入资产"
  ...
  methods:{
    ...
    formSubmit(){
      ...
      if(this.flagpic < this.upfiles1.length){
              ...
              picform.append('picform',this.picinfo)
